      ...
      header={
        <>
          <TableHeader
            headerText="tx"
            size="s"
            // tooltipText="Each transaction on the curve represents a transaction. The first 3 transactions are generated by the market scenario. You can add up to 3 more."
          />
          <TableHeader headerText="reserve" tooltipText="" />
          <TableHeader
