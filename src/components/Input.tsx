  ...
  return (
    <div className="px-9 pb-2 text-gray-100 lg:grid lg:grid-cols-2">
      ...
      <div className="relative h-11">
        <input className="font-bj font-bold text-neon-light text-xl w-full h-full pl-3 border-2 border-gray-500 hover:border-neon bg-transparent outline-none placeholder-right" />
