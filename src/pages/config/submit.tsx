  ...
  async function submitParams() {
    ...
    const chosenParams = {
      ...
      augmentedBondingCurve: {
        ...
        totalHatchFunding: Number(params.totalHatchFunding),
        totalInitialTechSupply: Number(params.totalInitialTechSupply),
        hatchFinalTechPrice: Number(params.hatchFinalTechPrice),
        includeMilestones: 1,
      },
      taoVoting: {
