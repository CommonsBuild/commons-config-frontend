...
function Dashboard() {
  ...
  return (
    <>
      <Head>
        <title>Token Lockup | Commons Dashboard</title>
      </Head>
        ...
        <div className="lg:flex">
          ...
          <div className="flex flex-col bg-transparent w-10/12 mx-auto mt-4 lg:w-7/12 lg:mt-4">
            ...
            <div className="min-w-full px-9 pt-4 pb-2 mt-auto">
              <div className="flex justify-between font-bj font-bold text-gray-100 text-xs uppercase border-b border-gray-100 px-2 pb-2 mb-2">
              ...
              {tableRows.map((row, index) => (
                <div
                  key={index}
                  className="flex justify-between font-bj text-neon-light text-xs py-1 px-2 hover:bg-cyan-700 cursor-pointer"
                >
