    ...
    <>
      ...
      <div className="font-inter">
        ...
        <p>
          ...
          initialization of the Commons which tokens remain fully locked, only
          at the end of the Token Freeze do tokens begin to thaw. This next
          period of time is known as the
          <strong>Token Thaw</strong>. We use this time for the Commons to
          establish value and start its initiatives. This mechanism is designed
          to guarantee, for a certain period, the minimum possible price of the
          token or, price floor.
        </p>
        <br />
        <p>
          ...
          1:1 TEC/TECH ratio. The
          <strong>Opening Price</strong> is the price we sell TEC tokens on the
          Augmented Bonding Curve after the Commons Upgrade is complete.
        </p>
        <br />
        <p>
