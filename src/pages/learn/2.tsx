          ...
          <div className="col-span-2 text-white">
            ...
            <div className="font-inter">
              ...
              <p>
                ...
                in wxDAI from buy orders to the curve is the <strong>Entry Tribute</strong>.
                Conversely, the percentage taken from sell orders is the <strong>Exit
                Tribute</strong>. This means that for every action on the curve the
              ...
              <p>
                ...
                the Commons’ projects. This percentage is the <strong>Commons Tribute</strong>.
              </p>
              <br />
