          ...
          <div className="col-span-2 text-white">
            ...
            <div className="font-inter">
              ...
              <p>
                ...
                <strong>Minimum Quorum</strong> ,
                <strong>Execution Delay</strong>
              ...
              <br />
              <p>
                TEC Token holders can delegate their Tao Voting powers to
                another member who will cast votes on their behalf, these
                members become delegates. Delegates can only vote during the
                <strong>Delegate Voting Period</strong>, which is a specified
                amount of time at the beginning of the voting process. If a
                delegate votes contrary to their delegator the delegator can
                veto the delegated vote and cast their vote themselves. Any
                voter, delegate or otherwise, can only vote ONCE.
              </p>
              <br />
              ...
              <p>
                ...
                <strong>Quiet Ending Period</strong> (QEP). If during this
                period the vote outcome is flipped the
                <strong>Quiet Ending Extension</strong>(QEE) will trigger. The
                QEE will add more time to the voting period, giving eligible
